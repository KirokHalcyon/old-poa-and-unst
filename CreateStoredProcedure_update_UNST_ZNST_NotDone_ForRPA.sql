...
-- =============================================
CREATE PROCEDURE [dbo].[update_UNST_ZNST_NotDone_ForRPA] (@Whse_Num varchar(50), @Inv_Num varchar(50))
...
GRANT EXECUTE ON OBJECT::[dbo].[update_UNST_ZNST_NotDone_ForRPA]
